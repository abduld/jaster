...
module Core {
    ...
    export class Int32 implements CNumber, IntegerTraits, SignedIntegerTraits {
    ...
    CNumberKindMap.set(CNumberKind.Int32, Int32);
    applyMixins(Int32, [IntegerTraits, SignedIntegerTraits]);
}
export = Core;