...
module Core {
    export class Uint32 implements CNumber, IntegerTraits, UnsignedIntegerTraits {
    ...
    CNumberKindMap.set(CNumberKind.Uint32, Uint32);
    applyMixins(Uint32, [IntegerTraits, UnsignedIntegerTraits]);
}