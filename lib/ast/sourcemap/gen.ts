...
module lib.ast {
    export module sourcemap {
        ...
        import util = lib.ast.sourcemap.utils;
        ...
        export class SourceMapGenerator {
             ...
             */
            private applySourceMap(aSourceMapConsumer, aSourceFile, aSourceMapPath) {
            ...
            private _serializeMappings() {
                ...
                this._mappings.sort(utils.compareByGeneratedPositions);
                ...
                for (var i = 0, len = this._mappings.length; i < len; i++) {
                    ...
                    if (mapping.generatedLine !== previousGeneratedLine) {
                        ...
                        if (i > 0) {
                            if (!utils.compareByGeneratedPositions(mapping, this._mappings[i - 1])) {
                                continue;
                            }
                            result += ',';
                        }
