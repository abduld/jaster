...
module lib.utils {
    ...
    */
    function parse(ua) {
        ...
        * @type string|null
        */
        export var layout = layout && layout[0];
        ...
        * @type string|null
        */
        export var prerelease = prerelease;
        ...
        * @type string|null
        */
        export var version = name && version;
        ...
        */
        ...
        export var toString = toStringPlatform;
